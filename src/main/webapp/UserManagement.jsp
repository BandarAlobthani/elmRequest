                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.password" name="pass" class="form-control input-sm" placeholder="Enter your Password" required ng-minlength="3"/>
                              <div class="has-error" ng-show="myForm.$dirty">
                                      <span ng-show="myForm.pass.$error.required">This is a required field</span>
                                      <span ng-show="myForm.pass.$error.minlength">Minimum length required is 3</span>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.lasttname" id="lastname" class="form-control input-sm" placeholder="Enter your Last Name"/>
                              </div>
                          </div>
                      </div>
